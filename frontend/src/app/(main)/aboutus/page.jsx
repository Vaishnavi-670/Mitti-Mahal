    ...
    <div className="bg-white py-14 w-full px-5 md:px-10 lg:px-20">
      <div className="  space-y-16">
        ...
        <div className='flex  items-center justify-center gap-10'>
          ...
          <div className="grid w-[90%] gap-10 items-center">
            <div className="md:order-1">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Sustainability & Eco-Friendliness</h2>

              <p className="text-lg text-gray-600 mt-4">
                By choosing handcrafted clay products, you support sustainable practices and skilled artisans who keep traditional pottery alive.
                Every purchase you make is a step towards a more eco-conscious lifestyle.
              </p>
            </div>
            <div className="order-1 md:order-2">
              <img
                src="https://i.pinimg.com/474x/5e/a2/36/5ea236f37b877476cc53d16f29ff7bc3.jpg"
                alt="Eco-friendly Pottery"
                className="rounded-lg h-80 shadow-lg w-full object-cover"
              />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
          <div className="col-span-2">
            <video
              src="celebration.mp4" autoPlay muted loop
              controls
        ...
        <div className="bg-gray-800 text-white py-16 px-8 md:px-16 lg:px-32 text-center rounded-lg shadow-lg">
          ...
          <p className="text-lg mb-8">
            We truly appreciate your trust in Mitti Mahal. Your support helps us keep the tradition of handcrafted pottery alive. Stay tuned for more exciting collections and exclusive offers!
          </p>
          <a
            href="/listingitems"
