  ...
  return ( 
    <div data-scroll-container ref={scrollRef}>
      <section data-scroll-section className="pt-24 bg-white">
        ...
        <div>
          <div className='flex flex-col'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
              ...
              <div className="h-80 w-80 bg-white shadow-lg rounded-lg p-4">
                <div className="h-32 w-32 mx-auto mb-4">
                  <img src="path/to/image3.jpg" alt="Review 3" className="h-full w-full object-cover rounded-full" />
                </div>
                <h3 className="text-xl font-semibold mb-2">Lorem ipsum dolor sit amet.</h3>
                <p className="text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium ad pariatur voluptatem tenetur. Doloremque, est provident officiis a mollitia qui.</p>
              </div>
        ...
        <div className="bg-white py-20 h-[100vh]">
          <div className="container mx-auto px-6 h-full">
            ...
            <div className="flex flex-wrap justify-center h-[90vh]">
              <div className="w-full h-[500px] md:w-1/3 p-4">
                <div className="bg-gray-100 h-[350px] p-6 rounded-lg shadow-lg text-center">
              ...
              <div className="w-full md:w-1/3 h-[500px] p-4">
                <div className="bg-gray-100 h-[350px] p-6 rounded-lg shadow-lg text-center">
                  ...
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBIX0Jp3XhqW22kHUbTlNzyFldXKFJ462EXOCmtJaSyNFtz9WVU56J8wOX-nPdooTzSiU&usqp=CAU" alt="Workshops & Classes" className="mt-4 mx-auto rounded-lg shadow-md" />
                </div>
              </div>
              <div className="w-full md:w-1/3 h-[500px] p-4">
                <div className="bg-gray-100  h-[350px] p-6 rounded-lg shadow-lg text-center">
                  ...
                  <img src="https://mitticool.com/wp-content/uploads/2018/04/240817_MittiCool_02.jpg" alt="Eco-Friendly Materials" className="mt-4 mx-auto h-[170px] rounded-lg shadow-md" />
                </div>
              </div>
              <div className="w-full md:w-1/3 p-4">
                <div className="bg-gray-100 p-6 rounded-lg shadow-lg text-center">
                  ...
                  <img src="https://i0.wp.com/moss51.com/wp-content/uploads/2023/09/photo-1631125915902-d8abe9225ff2-lanscape.jpeg?ssl=1" alt="Wide Range of Products" className="mt-4 mx-auto rounded-lg shadow-md" />
                </div>
              </div>
              <div className="w-full md:w-1/3 p-4">
                <div className="bg-gray-100 p-6 rounded-lg shadow-lg text-center">
                  ...
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXQmiaGbk--epXwoFJPSB5uxTJlS5H7LC7ww&s" alt="Gift Wrapping Services" className="mt-4 mx-auto rounded-lg shadow-md" />
                </div>
              </div>
            </div>
          </div>
